  ...
  return (
    <div className="max-w-screen-lg px-6r mx-auto mt-16 text-white">
      ...
      <div className="mt-10 max-w-prose">
        ...
        <p className="mt-4 leading-relaxed "> Myself and my fellow designer were tasked with creating a marketing site
      ...
      <div className="mt-10 section">
        <div className="max-w-prose">
          ...
          <p className="mt-4 text-sm leading-relaxed ">The Untappd Virtual fest was conceptualized, negotiated, put on sale,
