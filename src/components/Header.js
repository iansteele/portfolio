...
function Header(props) {
  return (
    <header className="flex items-center justify-between p-6 text-primary">
      <Link to="/portfolio" className="inline-flex items-center flex-grow-0 text-white">
        ...
        <h1 className="hidden ml-2 font-bold text-white brand-primary sm:block">STEELE DESIGN<span className="relative ml-1 text-sm tracking-wide border-b-2 text-brand-secondary -top-1 ">co</span></h1>
      </Link >
