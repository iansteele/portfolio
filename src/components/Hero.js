...
function Hero(props) {
  return (
    <div className="flex flex-col items-center flex-grow px-6 pt-16 pb-12 m-4 mt-0 text-center text-white md:pb-16 md:pt-24 xl:pb-24 xl:pt-24 bg-gray bg-opacity-5 rounded-xl md:m-6 md:mt-0">
      ...
      <p className="mt-4 text-lg ">Currently, I'm crafting a K-12 curriculum platform with the amazing folks @ <a className="font-semibold transition-colors text-brand-secondary hover:text-white" href="https://www.ilclassroom.com">IL Classroom</a></p>
      <p className="mt-8 text-gray">Previously @  <a className="font-semibold transition-colors hover:text-white" href="https://www.untappd.com">Untappd</a></p>
    </div>
  )
}
