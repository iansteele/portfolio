...
function Hero(props) {
  return (
    <div className="relative flex flex-col-reverse items-center justify-center md:justify-start flex-grow gap-6 px-6 py-24 mt-0 text-brand-tertiary min-h-[50vh] md:gap-10 md:flex-row rounded-xl ">
