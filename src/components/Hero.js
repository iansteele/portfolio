...
function Hero(props) {
  return (
    <div className="relative flex flex-col-reverse items-center justify-between flex-grow gap-6 px-6 py-24 mt-0 text-white sm:py-10 md:gap-10 md:flex-row rounded-xl ">
