  ...
  return (
    <header className="flex text-primary items-center justify-between p-6">
      <Link to="/portfolio" className="inline-flex text-white items-center flex-grow-0">
        ...
        <h1 className="hidden brand-primary font-bold text-white sm:block ml-2">STEELE DESIGN<span class="ml-1 text-brand-secondary text-sm relative tracking-wide border-b-2 -top-1 ">co</span></h1>
      </Link >
