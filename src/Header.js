  ...
  return (
    <header className="flex text-primary items-center justify-between py-6 px-4">
      <Link to="/portfolio" className="inline-flex text-brand-secondary items-center flex-grow-0">
        ...
        <h1 className="hidden brand-primary tracking-wide font-bold text-white text-lg sm:block ml-2">STEELE DESIGN<span class="ml-1 text-brand-secondary text-sm relative tracking-wide border-b-2 -top-1 ">co</span></h1>
      </Link >
