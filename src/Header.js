...
function Header(props) {
  return (
    <header className="flex text-primary items-center justify-between py-6 px-4">
      <Link to="/portfolio" className="inline-flex text-brand-secondary items-center flex-grow-0">
        ...
        <h1 className="hidden brand-primary font-display tracking-narrow font-bold text-white text-xl sm:block ml-2">Steele Design <span class="text-brand-secondary text-sm relative bottom-2 tracking-widest">co</span></h1>
      </Link >
