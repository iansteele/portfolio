...
function Header(props) {
  return (
    <header className="flex text-primary items-center justify-between p-6">
      <Link to="/portfolio" className="inline-flex text-white items-center flex-grow-0">
        <svg className="w-8 h-8 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 180">
        ...
        <h1 className="hidden brand-primary tracking-wide font-bold text-white sm:block ml-2">STEELE DESIGN<span class="ml-1 text-brand-secondary text-sm relative tracking-wide border-b-2 -top-1 ">co</span></h1>
      </Link >
      <nav className="flex font-bold text-sm space-x-3 md:space-x-4 text-brand-secondary">
