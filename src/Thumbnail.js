...
function Thumbnail(props) {
  return (
      <Link className="transform transition duration-500 hover:ring hover:ring-brand-secondary hover:ring-offset-2 hover:scale-101 rounded-3xl relative overflow-hidden " to={props.link}>
