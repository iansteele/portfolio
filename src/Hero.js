...
function Hero(props) {
  return (
    <div className="flex-grow flex flex-col text-center items-center text-white pb-12 pt-16 md:pb-16 px-6 md:pt-24 xl:pb-24 xl:pt-24 bg-gray bg-opacity-5 rounded-xl m-4 mt-0 md:m-6 md:mt-0">
