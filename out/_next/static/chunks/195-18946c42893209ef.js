  ...
  [195],
  {
    5195: function (e, t, a) {
      ...
      var s = a(9008),
        ...
        i = function (e) {
          return (0, r.jsx)("header", {
            className:
              "sticky top-0 z-10 flex items-center w-full px-6 py-3 bg-brand-primary text-primary",
            children: (0, r.jsxs)("div", {
              ...
              children: [
                (0, r.jsxs)(o(), {
                  href: "/",
                  className:
                    "inline-flex items-center flex-grow-0 gap-3 text-brand-tertiary",
                  children: [
                    (0, r.jsx)("svg", {
                    ...
                    (0, r.jsx)("div", {
                      className:
                        "hidden text-lg font-bold tracking-wider sm:block",
                      children: "IAN STEELE",
                    }),
                  ],
                }),
                (0, r.jsxs)("nav", {
                  className:
                    "flex items-center space-x-3 text-xs font-bold tracking-widest md:space-x-4 ",
                  children: [
                    (0, r.jsxs)("a", {
                      className:
                        "relative px-1 py-3 uppercase transition-all transform text-brand-secondary hover:text-brand-tertiary group active:scale-90",
                      href: "https://www.notion.so/Ian-Steele-ca6f009ed2204389be0a2d3a0ee99788",
                      children: [
                        "Resume",
                        (0, r.jsx)("span", {
                          className:
                            "absolute rounded-full left-0 w-0 h-1 transition-all duration-500 ease-in-out bg-brand-secondary -bottom-0.5 group-hover:w-full",
                        }),
                      ],
                    }),
                    (0, r.jsxs)("a", {
                      className:
                        "relative px-1 py-3 ml-2 uppercase transition-all transform text-brand-secondary hover:text-brand-tertiary group active:scale-90",
          ...
          return (0, r.jsxs)("ul", {
            ...
            children: [
              (0, r.jsx)("li", {
                children: (0, r.jsxs)("a", {
                  className:
                    "relative flex items-center justify-center w-10 h-10 cursor-pointer group",
                  href: "http://www.dribbble.com/iansteele",
                  alt: "Ian on Dribbble",
                  children: [
                    (0, r.jsx)("svg", {
                      className:
                        "w-6 transition-all duration-500 transform fill-brand-secondary group-hover:fill-brand-tertiary group-hover:-translate-y-1 group-hover:scale-105 group-active:translate-y-0",
                      xmlns: "http://www.w3.org/2000/svg",
                      viewBox: "0 0 900 900",
                      children: (0, r.jsx)("path", {
                        id: "ball",
                    ...
                    (0, r.jsx)("span", {
                      className:
                        "absolute rounded-full left-0 w-full h-0 transition-all duration-500 ease-in-out bg-brand-secondary -bottom-0.5 group-hover:h-1 opacity-0 group-hover:opacity-100 group-active:h-0.5",
                    }),
                  ],
                }),
              }),
        ...
        d = function (e) {
          return (0, r.jsxs)("footer", {
            className:
              "flex flex-col items-center w-full gap-8 px-6 py-16 sm:gap-4 text-brand-tertiary",
            children: [
              (0, r.jsx)("p", {
              ...
              (0, r.jsxs)("a", {
                ...
                className:
                  "relative py-1 text-xl font-bold transition-colors cursor-pointer group text-brand-secondary hover:text-brand-tertiary",
                children: [
      ...
      function x(e) {
        ...
        return (0, r.jsxs)("div", {
          className: "flex flex-col items-center bg-brand-primary mx-auto",
          children: [
            (0, r.jsxs)(n(), {
              children: [
                (0, r.jsx)("title", { children: l.title }),
                (0, r.jsx)("meta", {
                  name: "robots",
                ...
                (0, r.jsx)("meta", {
                  property: "og:url",
                  content: "https://yourwebsite.com".concat(s.asPath),
                }),
                (0, r.jsx)("link", {
                  rel: "canonical",
                  href: "https://yourwebsite.com".concat(s.asPath),
                }),
                (0, r.jsx)("meta", { property: "og:type", content: l.type }),
                (0, r.jsx)("meta", {
                ...
                (0, r.jsx)("meta", { property: "og:title", content: l.title }),
                (0, r.jsx)("meta", { property: "og:image", content: l.image }),
                (0, r.jsx)("meta", {
                  name: "twitter:card",
                ...
                (0, r.jsx)("meta", { name: "twitter:title", content: l.title }),
                (0, r.jsx)("meta", {
                  name: "twitter:description",
                  content: l.description,
                }),
                (0, r.jsx)("meta", { name: "twitter:image", content: l.image }),
                l.date &&
                  (0, r.jsx)("meta", {
            ...
            (0, r.jsx)(i, {}),
            (0, r.jsx)("main", { className: "py-10", children: t }),
            (0, r.jsx)(d, {}),
          ],
        });
      }
      var p = function (e) {
          return (0, r.jsx)("div", {
            className:
              "w-full space-y-16 max-w-screen-lg px-6 mx-auto text-brand-tertiary",
            children: e.children,
          });
        },
        m = function (e) {
          ...
          return (0, r.jsxs)("div", {
            ...
            children: [
              (0, r.jsx)("p", {
                className: "font-semibold tracking-wide text-brand-secondary",
                children: e.client,
              }),
              (0, r.jsx)("h1", {
                className:
                  "text-6xl font-bold tracking-tight md:text-7xl font-display",
                children: e.title,
              }),
              (0, r.jsx)("p", {
                className: "opacity-100 text-brand-tertiary max-w-prose",
                children: e.description,
              }),
              (0, r.jsx)(function () {
                return t
                  ? (0, r.jsx)("ul", {
                      className: "flex gap-4 opacity-75 text-brand-tertiary",
                      children: e.roles.map(function (e, t) {
                        return (0,
                        r.jsx)("li", { className: "text-xs", children: e }, t);
                      }),
                    })
                  : null;
              }, {}),
        ...
        h = function (e) {
          return (0, r.jsx)("h2", {
            className: "inline-flex text-brand-secondary max-w-prose",
            children: e.children,
          });
        };
    },
