  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <path
          className="block transition-all origin-center opacity-100 group-active:scale-100 dark:opacity-0 dark:hidden group-active:fill-current group-hover:fill-current animate group-hover:animate-pulse"
          strokeLinecap="round"
          strokeLinejoin="round"
          fillOpacity=".5"
